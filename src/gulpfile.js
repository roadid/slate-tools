...
gulp.task('build', (done) => {
  runSequence(
    ['clean'],
    ['build:webpack', 'build:js', 'build:vendor-js', 'build:css', 'build:vendor-css', 'build:assets', 'build:config', 'build:svg'],
    ['output:errors'],
    done,
  );
});
...
gulp.task('build:zip', (done) => {
  runSequence(
    ['clean'],
    ['build:webpack', 'build:js', 'build:vendor-js', 'build:css', 'build:vendor-css', 'build:assets', 'build:svg'],
    done,
  );
});
