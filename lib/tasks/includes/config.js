...
var logger = require('debug')('slate-tools');
...
var config = {
  ...
  src: {
    ...
    webpackAllFiles: 'src/scripts_webpack/**/*.{js,ts,tsx,vue,css,scss}',
    webpackOutputFiles: 'src/scripts_webpack/*.{js,ts,tsx,vue,css,scss}',
